...
\begin{document}
	...
	\end{consequense}
	\subsection{Площадь параллелограммма}
	\begin{definition}
	...
	\begin{definition}
		\ Ориентированной площадью параллелограммма, натянутого на векторы $\bar{a},\bar{b}$, называется число, равное $S_{\bar{a},\bar{b}}$, если пара $\bar{a},\bar{b}$ положительна, и $-S_{\bar{a},\bar{b}}$ иначе. Обозначается $<\bar{a}, \bar{b}>$.
	\end{definition}
	\begin{consequense}
		В любом положительно ориентированном базисе $<\bar{a}, \bar{b}> = \begin{vmatrix} x_1&y_1\\x_2&y_2 \end{vmatrix}$
	\end{consequense}
	\subsection{Свойства ориентированной площади}
	...
	\end{proof}
	\bfseries Мораль в том, что дальше очев... \\(по свойствам групп, которые вы найдёте у \href{https://github.com/Viacheslavik122333/Halgebra1sem/blob/main/lecture.pdf}{Viacheslavik122333}) \mdseries
\end{document}