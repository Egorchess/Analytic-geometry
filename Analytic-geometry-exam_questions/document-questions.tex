...
\begin{document}
	...
	\bfseries Вот так, дорогие друзья, и не заканчивается эта история, потому что дослали ещё билетов))\\
	Благодарю за чтение)\mdseries

	\bfseries Мораль в том, что дальше жесть с линиями второго порядка...\mdseries
\end{document}