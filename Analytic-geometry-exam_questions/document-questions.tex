...
\begin{document}
	...
	\begin{definition}
		\ Ориентированной площадью параллелограмма, натянутого на векторы $\bar{a},\bar{b}$, называется число, равное $S_{\bar{a},\bar{b}}$, если пара $\bar{a},\bar{b}$ положительна, и $-S_{\bar{a},\bar{b}}$ иначе. Обозначается $<\bar{a}, \bar{b}>$.
	\end{definition}
	\begin{consequense}
	...
	\end{consequense}
	\bfseries Мораль в том, что дальше очев... \\(по свойствам орбит, с которыми разбирается \href{https://github.com/Viacheslavik122333/Halgebra1sem/blob/main/lecture.pdf}{Viacheslavik122333}) \mdseries
\end{document}